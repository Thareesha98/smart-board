...
export default function StudentBoardingsScreen() {
  ...
  const [minKeyMoney, setMinKeyMoney] = useState("");
  const [maxKeyMoney, setMaxKeyMoney] = useState("");
  ...
  const buildQueryParams = () => {
    ...
    if (minKeyMoney) params.append("minKeyMoney", minKeyMoney);
    if (maxKeyMoney) params.append("maxKeyMoney", maxKeyMoney);
  ...
  useEffect(() => {
    loadBoardings(true);
  }, [searchText, genderFilter, typeFilter, minPrice, maxPrice , minKeyMoney, maxKeyMoney]);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.filterBlock}>
          <Text style={styles.filterLabel}>Key Money (Rs)</Text>
          <View style={styles.priceRow}>
            <TextInput
              style={styles.priceInput}
              placeholder="Min"
