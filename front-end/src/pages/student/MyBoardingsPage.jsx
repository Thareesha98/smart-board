    ...
    >
      <AnimatePresence mode="wait">
        {hasBoarding ? (
          ...
          // ✅ CASE 1: PENDING — show limited card
          ...
          // ✅ CASE 2: LEAVE_REQUESTED — show full dashboard BUT with leave pending banner
          ) : currentBoarding.status === "LEAVE_REQUESTED" ? (
            <motion.div
              key="leave-requested-boarding"
            ...
            >
              <div className="w-full min-[1400px]:col-span-2 space-y-6">
                {/* ✅ Leave pending banner at the top */}
                <LeaveBoardingSection boarding={currentBoarding} />
                {/* Still show boarding info but actions are read-only */}
                <BoardingCard
          ...
          // ✅ CASE 3: APPROVED — show full dashboard with leave button
          ) : (
            <motion.div
              key="active-boarding"
              initial={{ opacity: 0, y: 20 }}
