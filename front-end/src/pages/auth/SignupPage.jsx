...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 py-8 overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-primary/30 backdrop-blur-sm" />
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        >
          <Link
            to="/login"
            className="inline-flex items-center gap-2 text-white mb-6 font-semibold bg-white/10 px-4 py-2 rounded-lg backdrop-blur-sm hover:bg-white/20"
          >
            <FaArrowLeft /> Back to Login
          </Link>
        </motion.div>
            ...
            <div className="flex max-w-md mx-auto p-1 bg-gray-100 rounded-lg mb-8 shadow-inner">
              {["student", "owner", "technician"].map((r) => (
                <button
                  ...
                  className={`flex-1 py-2 text-sm font-semibold rounded-md capitalize transition-all ${role === r ? "bg-white text-primary shadow-sm" : "text-gray-500"}`}
                >
                  {r}
                </button>
              ))}
              ...
              >
                <form onSubmit={handleOtpVerification} className="space-y-6">
                  <input
                    ...
                    className="w-full text-center text-3xl tracking-[0.5em] font-bold py-4 border-2 rounded-xl"
                    autoFocus
                  />
                  <button
                    type="submit"
