...
const AccountSection = ({ ownerData, onSecurity }) => {
  ...
  const accountItems = [
    { label: 'Username', value: ownerData.username },
    { label: 'Member Since', value: formatDate(ownerData.joinDate) },
    { label: 'Default Payment Method', value: ownerData.paymentMethod },
