        ...
        <>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <DetailRow
                  ...
                  value={
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold uppercase ${severityColor}`}
                    >
                      {report.priority || "LOW"}
                    </span>
                  }
                ...
                {report.incidentDate && (
                  <DetailRow
                    label="Incident Date"
                    value={formatDate(report.incidentDate)}
                  />
                )}

                {report.boarding && (
                  <DetailRow label="Boarding" value={report.boarding} />
                )}

                {report.reportedPerson && (
                  <DetailRow
                    label="Reported Person"
                    value={report.reportedPerson}
                  />
                )}
                      ...
                      {report.evidence.type === "image" ? (
                        <div className="relative group">
                          <img
                            ...
                            onClick={() =>
                              setSelectedImage(report.evidence.url)
                            }
                          />
                        ...
                        <a
                          ...
                          className="flex items-center gap-2 p-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors text-accent"
                        >
          ...
          {selectedImage && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              // Z-Index must be higher than modal (2000 -> 3000)
